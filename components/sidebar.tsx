...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div className="hidden  w-36 md:w-40 sm:mt-16 self-start sm:flex bg-zinc-900/90 rounded-lg border border-zinc-800  h-[60dvh] text-center">
      <div className={`relative w-full h-full whitespace-nowrap`}>
        <h3 className="sticky top-0 left-0 right-0 font-semibold font-kanit text-center text-zinc-500 text-sm p-2 border-b border-b-zinc-800">
          Your Chats :)
        </h3>
