...
const UserGuidePageHeader = () => {
  ...
  return (
    <div className="sticky z-10 top-4 flex items-center gap-2 sm:gap-4 md:gap-6 ml-6 sm:ml-10 md:ml-24">
      <div
        className={`${isScrolling ? "border-[1px] bg-neutral-800/90 backdrop-blur-sm border-neutral-700/60 rounded-full" : ""} px-2 py-1 flex items-center gap-2 sm:gap-4 md:gap-6`}
      >
